...
public class FoursquareApi {
  ...
  public final void testFoursquareApiStringStringString() {
    br.com.zahpee.foursquare.api.FoursquareApi foursquareApi = new br.com.zahpee.foursquare.api.FoursquareApi("clientId", "clientSecret", "redirectUrl");
  ...
  public final void testFoursquareApiStringStringStringStringIOHandler() {
    br.com.zahpee.foursquare.api.FoursquareApi foursquareApi = new br.com.zahpee.foursquare.api.FoursquareApi("clientId", "clientSecret", "redirectUrl", "token", new TestIO());
    assertEquals("token", foursquareApi.getOAuthToken());
  }

  @Test
  public final void testSetoAuthToken() {
    br.com.zahpee.foursquare.api.FoursquareApi foursquareApi = TestUtils.getAnonymousFoursquareApi();
    assertNull(foursquareApi.getOAuthToken());
  ...
  public final void testIOError() throws FoursquareApiException {
    br.com.zahpee.foursquare.api.FoursquareApi foursquareApi = TestUtils.getAuthenticatedFoursquareApi();
    foursquareApi.setUseCallback(false);
